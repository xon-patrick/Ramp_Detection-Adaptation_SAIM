...
class RampDetectionTrainer:
    ...
    def __init__(self, project_root=None):
        ...
        print(f"\n{'=' * 60}")
        print("YOLOv8 Ramp Detection Training (from scratch)")
    ...
    def train(self):
        ...
        # Load model from YAML to ensure no pretrained weights are used.
        model = YOLO(f"{self.config['model_architecture']}.yaml")
    ...
    def plot_loss_curves(self):
        ...
        results_csv = self.project_root / "runs" / self.model_name / "results.csv"
        ...
        try:
            ...
            if loss_idx is not None and val_loss_idx is not None:
                ...
                plt.title(
                    "YOLOv8 Training Loss Curves", fontsize=14, fontweight="bold"
                )
    ...
    def evaluate_test_set(self):
        ...
        try:
            ...
            f1_per_class = 2 * (precision_list * recall_list) / (
                precision_list + recall_list + 1e-6
            )
    ...
    def save_configuration(self):
        ...
        config_to_save["dataset_info"] = {
            "total_images": 236,
            "classes": {"rampDown": 119, "rampUp": 154, "ramps-railing": 729},
        }
